    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button onClick={() => { setError(""); setIsCreateModalOpen(true); }} className="flex items-center gap-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 px-4 py-2.5 text-sm font-bold text-slate-900 shadow-lg shadow-cyan-500/25 transition">
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-white/5 bg-[#1E293B] p-16 flex flex-col items-center justify-center text-center gap-4">
          <div className="rounded-full bg-cyan-500/10 p-4"><Users className="h-8 w-8 text-cyan-400" /></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {groups.map((group: any) => (
            <div key={group.id} className="rounded-2xl border border-white/5 bg-[#1E293B] p-5 flex flex-col hover:border-white/10 transition group">
              ...
              <div className="flex -space-x-2 my-3">
                ...
                {(group.members?.length || 0) > 4 && (
                  <div className="h-8 w-8 rounded-full border-2 border-[#1E293B] bg-cyan-500/20 text-cyan-400 flex items-center justify-center text-xs font-bold">
